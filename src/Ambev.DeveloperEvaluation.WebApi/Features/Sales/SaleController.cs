...
namespace Ambev.DeveloperEvaluation.WebApi.Features.Sales
{
    ...
    public class SaleController : BaseController
    {
        ...
        public async Task<IActionResult> CreateSaleOrder([FromBody] CreateSaleResquest request, CancellationToken cancellationToken)
        {
        ...
        {
            var request = new GetSaleResquest { Id = id };
